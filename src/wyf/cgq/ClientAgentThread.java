...
public class ClientAgentThread extends Thread
{
			...
			try{
				...
				if(msg.startsWith("<#NAME_CHONGMING#>")){//收到重名的信息
					...
					this.renshu();
                                ...
                                else if(msg.startsWith("<#REGIVE#>")){//当收到悔棋的信息时
					this.regive(g1);
				}
    ...
    public void regive(Graphics g) {
       this.father.jbregive.setEnabled(false);//将"悔棋"按钮设为不可用
                        this.father.walknum--;
                        this.father.opsitewalknum--;
                        
                          if(this.father.color==1)//如果己方是虎
                         {
                             ...
                             this.father.jpz.qiZi[this.father.jpz.posbefore[1][2]][this.father.jpz.posbefore[1][3]]=null;//走棋
                             if(this.father.jpz.posbefore[1][4]==1){
                                 this.father.qiZi[this.father.jpz.posbefore[1][2]][this.father.jpz.posbefore[1][3]-1]=new QiZi(color1,"狗",this.father.jpz.posbefore[1][2],this.father.jpz.posbefore[1][3]-1);
                                 this.father.qiZi[this.father.jpz.posbefore[1][2]][this.father.jpz.posbefore[1][3]+1]=new QiZi(color1,"狗",this.father.jpz.posbefore[1][2],this.father.jpz.posbefore[1][3]+1);
                             }
                             if(this.father.jpz.posbefore[1][5]==1){
                                 this.father.qiZi[this.father.jpz.posbefore[1][2]-1][this.father.jpz.posbefore[1][3]]=new QiZi(color1,"狗",this.father.jpz.posbefore[1][2]-1,this.father.jpz.posbefore[1][3]);
                                 this.father.qiZi[this.father.jpz.posbefore[1][2]+1][this.father.jpz.posbefore[1][3]]=new QiZi(color1,"狗",this.father.jpz.posbefore[1][2]+1,this.father.jpz.posbefore[1][3]);
                             }
                             if(this.father.jpz.posbefore[1][7]==1){
                                 this.father.qiZi[this.father.jpz.posbefore[1][2]-1][this.father.jpz.posbefore[1][3]-1]=new QiZi(color1,"狗",this.father.jpz.posbefore[1][2]-1,this.father.jpz.posbefore[1][3]-1);
                                 this.father.qiZi[this.father.jpz.posbefore[1][2]+1][this.father.jpz.posbefore[1][3]+1]=new QiZi(color1,"狗",this.father.jpz.posbefore[1][2]+1,this.father.jpz.posbefore[1][3]+1);
                             }
                             ...
                             this.father.jpz.qiZi[this.father.jpz.opsiteposbefore[1][2]][this.father.jpz.opsiteposbefore[1][3]]=null;//走棋       
                         }
                       ...
                       else
                         {
                             ...
                             if(this.father.jpz.opsiteposbefore[1][4]==1){
                                 this.father.qiZi[this.father.jpz.opsiteposbefore[1][2]][this.father.jpz.opsiteposbefore[1][3]-1]=new QiZi(color1,"狗",this.father.jpz.opsiteposbefore[1][2],this.father.jpz.opsiteposbefore[1][3]-1);
                                 this.father.qiZi[this.father.jpz.opsiteposbefore[1][2]][this.father.jpz.opsiteposbefore[1][3]+1]=new QiZi(color1,"狗",this.father.jpz.opsiteposbefore[1][2],this.father.jpz.opsiteposbefore[1][3]+1);
                             }
                             if(this.father.jpz.opsiteposbefore[1][5]==1){
                                 this.father.qiZi[this.father.jpz.opsiteposbefore[1][2]-1][this.father.jpz.opsiteposbefore[1][3]]=new QiZi(color1,"狗",this.father.jpz.opsiteposbefore[1][2]-1,this.father.jpz.opsiteposbefore[1][3]);
                                 this.father.qiZi[this.father.jpz.opsiteposbefore[1][2]+1][this.father.jpz.opsiteposbefore[1][3]]=new QiZi(color1,"狗",this.father.jpz.opsiteposbefore[1][2]+1,this.father.jpz.opsiteposbefore[1][3]);
                             }
                             if(this.father.jpz.opsiteposbefore[1][7]==1){
                                 this.father.qiZi[this.father.jpz.opsiteposbefore[1][2]-1][this.father.jpz.opsiteposbefore[1][3]-1]=new QiZi(color1,"狗",this.father.jpz.opsiteposbefore[1][2]-1,this.father.jpz.opsiteposbefore[1][3]-1);
                                 this.father.qiZi[this.father.jpz.opsiteposbefore[1][2]+1][this.father.jpz.opsiteposbefore[1][3]+1]=new QiZi(color1,"狗",this.father.jpz.opsiteposbefore[1][2]+1,this.father.jpz.opsiteposbefore[1][3]+1);
                             }
